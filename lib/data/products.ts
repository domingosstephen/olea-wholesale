...
const SEED_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    origin_region: null,
    short_description: 'Fully refined soybean oil for food manufacturing, commercial frying, and industrial applications.',
    long_description: 'Our Refined Soybean Oil is sourced from leading Brazilian crushing facilities and refined to the highest food-grade standards. With a neutral flavor, high smoke point, and versatile application profile, it is widely used in commercial frying, margarine production, salad dressings, baked goods, and processed food manufacturing.',
    specifications: {
      free_fatty_acid: { result: '0.05%', limit: '≤ 0.1%' },
      smoke_point: { result: '230°C', limit: '≥ 220°C' },
      iodine_value: { result: '131', limit: '120-140' },
      peroxide_value: { result: '1.2 mEq O2/kg', limit: '≤ 10' },
      moisture: { result: '0.05%', limit: '≤ 0.1%' },
    },
    certifications: ['ISO 22000'],
    hero_image_url: '/images/products/soybean-oil.png',
    gallery_images: null,
    base_unit_price_cents: 245,
    base_currency: 'USD',
    base_unit: 'liter',
    moq_liters: 2000,
    lead_time_days: 18,
    port_of_origin: 'Santos, Brazil',
    status: 'active',
    display_order: 4,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  ...
  },
  {
    ...
    hero_image_url: '/images/products/palm-oil-lab.jpeg',
    gallery_images: null,
